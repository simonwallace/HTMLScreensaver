        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var config = new ConfigurationBuilder()
                    ...
                    .AddJsonFile($"{nameof(HTMLScreensaver)}.json", optional: false, reloadOnChange: true)
                    .Build()
                    .GetSection(nameof(Screensaver))
                    .Get<Screensaver>();
                ...
                for (var i = 0; i < config.Screens.Count; i++)
                {
                    ...
                    if (number >= System.Windows.Forms.Screen.AllScreens.GetLowerBound(0)
                        && number <= System.Windows.Forms.Screen.AllScreens.GetUpperBound(0))
                    {
